...
<html>
    ...
    <body onload="window.print(); setTimeout(window.close, 0);">
        <div id="divToPrint">
            ...
            echo "<tr style='font-size: 8pt;' height = 20px>
				<td align=left width=5% align=left > SL  </td>

						<td align=left width=55%> Particulars  </td>
						<td align=left width=5%> HSN Code  </td>
...
$xGstValue=0;
            ...
            while ($row = mysql_fetch_array($result)) { // Creates a loop to loop through results
                ...
                echo "<tr class=hide_bottom style='font-size: 8pt;'> 
                        ...
                        <td align=right>"  . $xDiscountPercentage . "</td>
            ...
            echo "<tr><td align=center  width=10% colspan=2></td><td width=10%> 2.5% </td><td width=10%> 6% </td><td width=10%> 9% </td><td width=10%> 14% </td><td width=10%>  </td><td width=20% align=right> Total </td><td width=20% align=right> " . fn_RupeeFormat($xRoundOffTotal) . " </td></tr>";
            echo "<tr><td align=center  width=10% colspan=2>CGST</td><td width=10%> " . round($xFivePercentage, 2) . "  </td><td width=10%> " . round($xTwelvePercentage, 2) . " </td><td width=10%> " . round($xEighteenPercentage, 2) . " </td><td width=10%> " . round($xTwentyEightPercentage, 2) . " </td><td width=10%> ".  round($xcgst,2) ." </td><td width=20% align=right> GstTax </td><td width=20% align=right> " . $xGstValue . " </td></tr>";
            echo "<tr><td align=center  width=10% colspan=2>SGST</td><td width=10%> " . round($xFivePercentage, 2) . "  </td><td width=10%> " . round($xTwelvePercentage, 2) . "</td><td width=10%>" . round($xEighteenPercentage, 2) . " </td><td width=10%> " . round($xTwentyEightPercentage, 2) . " </td><td width=10%>".  round($xsgst,2) ."</td><td width=20% align=right> Total Amount </td><td width=20% align=right> " . number_format($xBeforeRoundOffNetTotal, 2) . " </td></tr>";
            echo "<tr><td align=center  width=10% colspan=2></td><td width=10%> " . round($xFivePercentage+$xFivePercentage, 2) . "  </td><td width=10%> " . round($xTwelvePercentage+$xTwelvePercentage, 2) . "</td><td width=10%>" . round($xEighteenPercentage+$xEighteenPercentage, 2) . " </td><td width=10%> " . round($xTwentyEightPercentage+$xTwentyEightPercentage, 2) . " </td><td width=10%>" . $xGstValue . " </td><td width=20% align=right> Round Off </td><td width=20% align=right> " . $xRoundOff . " </td></tr>";
            echo "<tr><td align=center  width=60% colspan=6>" . ucwords(convert_number_to_words($xAfterRoundOffNetTotal)) . " Rupees Only </td><td width=10%>  </td><td width=20% align=right> NetAmount </td><td width=20% align=right> " . number_format($xAfterRoundOffNetTotal, 2) . " </td></tr>";
