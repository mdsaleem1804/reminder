 ...
 <th align="right" width="10%">ReturnDate</th>
                                ...
                                <th align="right" width="10%">MRP</th>
								 <th align="right" width="10%">GST(%)</th>
								 		 <th align="right" width="10%">GST VALUE</th>
...
echo '<td align=right>' . $row ['credit_note_date'] . '</td>';
                                echo '<td align=right>' . $row ['qty'] . '</td>';
								 $xMrp=$row ['mrp'];
                                echo '<td align=right>' . $xMrp . '</td>';
								 
														$xGst=$GLOBALS ['xGst'];
														$xGstValue=($xMrp*($xGst/100));
	...
	echo '<td align=right>' . fn_RupeeFormat ( $xTotalGstValue/2 ) . '</td>';
	echo '<td align=right>' . fn_RupeeFormat ( $xTotalGstValue/2 ) . '</td>';
	echo '<td align=right>' . fn_RupeeFormat ( $xTotalGstValue ) . '</td>';
	echo '</tr>';
			echo '<tr>';
        }
?>	
